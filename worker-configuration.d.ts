/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 887bf288d3fdc9f7a1d3aa1f9586ad01)
// Runtime types generated with workerd@1.20251213.0 2025-12-19 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "ExpertAgent" | "JudgeAgent" | "Sandbox" | "OverseerAgent" | "OrchestratorAgent" | "QAAgent" | "ArchitectAgent" | "VerificationAgent";
	}
	interface Env {
		KV: KVNamespace;
		...
		GITHUB_TOKEN: string;
		EXPERT_AGENT: DurableObjectNamespace<import("./src/worker").ExpertAgent>;
		JUDGE_AGENT: DurableObjectNamespace<import("./src/worker").JudgeAgent>;
		SANDBOX: DurableObjectNamespace<import("./src/worker").Sandbox>;
		OVERSEER_AGENT: DurableObjectNamespace<import("./src/worker").OverseerAgent>;
		ORCHESTRATOR_AGENT: DurableObjectNamespace<import("./src/worker").OrchestratorAgent>;
		QA_AGENT: DurableObjectNamespace<import("./src/worker").QAAgent>;
		ARCHITECT_AGENT: DurableObjectNamespace<import("./src/worker").ArchitectAgent>;
		VERIFICATION_AGENT: DurableObjectNamespace<import("./src/worker").VerificationAgent>;
		BUCKET: R2Bucket;
		DB: D1Database;
		QUEUE_INGEST: Queue;
		QUEUE_WEBHOOK: Queue;
		QUEUE_ADVISOR: Queue;
		JULES_MCP_VECTORIZE: VectorizeIndex;
		AI: Ai;
		ASSETS: Fetcher;
		ADVISOR_WORKFLOW: Workflow<Parameters<import("./src/worker").AdvisorWorkflow['run']>[0]['payload']>;
		INGEST_WORKFLOW: Workflow<Parameters<import("./src/worker").IngestWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_GATEWAY_NAME" | "GEMINI_MODEL" | "OPENAI_MODEL" | "VECTOR_INDEX" | "JULES_API_KEY" | "MCP_AUTH_TOKEN" | "AUTH_DISABLED" | "CLOUDFLARE_ACCOUNT_ID" | "CF_AIG_TOKEN" | "CF_BROWSER_RENDER_TOKEN" | "CLOUDFLARE_AI_SEARCH_TOKEN" | "CLOUDFLARE_WORKER_ADMIN_TOKEN" | "CLOUDFLARE_OBSERVABILITY_TOKEN" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY" | "R2_ENDPOINT_URL" | "R2_BUCKET_NAME" | "CLOUFLARE_R2_TOKEN" | "GEMINI_API_KEY" | "OPENAI_API_KEY" | "GITHUB_TOKEN">> {}
}
